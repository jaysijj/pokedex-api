...
const Paginacao = ({setPaginacao, paginacao, generation, currentGeneration, loadingPkm}) => {
  function ola(){
  ...
  return (
    <div className='paginacaoFather'>
      ...
      <div className='paginacaoButton' >
        {!loadingPkm ? <div className='loadingImg__father'><img className='loadingImg' src='./assets/loading-pokemon4.gif'/></div>: paginacao+29<generation[currentGeneration][1] &&
        <div className='loadingArrow__father' onClick={() => paginacao<generation[currentGeneration][1] && setPaginacao(paginacao+30)}>
